...
# %% colab={"base_uri": "https://localhost:8080/"} id="viogUaE-cMp_" outputId="918366bd-8d5c-449f-d56e-672b7257874d"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 449} id="dgdX-tjNccbt" outputId="7f60baa9-b7e4-41bb-d35d-5f11fff4a0f8"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="GXnnVsHwct4e" outputId="b6ab2171-355d-453e-e8f5-9d41aa6e32b0"
print(accuracy_score(np.argmax(testY_CNN, axis=1), np.argmax(cnn_model.predict(testX_CNN), axis=1)))

# %% colab={"base_uri": "https://localhost:8080/", "height": 489} id="gcZvxGHPc-pX" outputId="12aea3ec-6784-47e9-8c1d-eb11844bbafd"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="-z35ARpHdQ5U" outputId="127ecb26-103a-4747-c654-48c350e27d02"
from sklearn.metrics import classification_report, accuracy_score
print(classification_report(np.argmax(testY_CNN, axis=1), np.argmax(cnn_model.predict(testX_CNN), axis=1)))

# %% colab={"base_uri": "https://localhost:8080/"} id="xbhRoKNwdBCU" outputId="6696cedf-1c0b-414e-9a10-4262fbf8b020"
print(accuracy_score(np.argmax(trainY_CNN, axis=1), np.argmax(cnn_model.predict(trainX_CNN), axis=1)))

# %% colab={"base_uri": "https://localhost:8080/", "height": 489} id="ONHxr0DFdDzO" outputId="23498c0e-f7b7-4267-f861-d9d7280773bd"
from sklearn.metrics import precision_recall_curve, auc
...
# %% colab={"base_uri": "https://localhost:8080/"} id="SCeY4FT0dbmd" outputId="924b8c7b-a3e0-4f98-ca6d-51864a2319c4"
from sklearn.metrics import classification_report, accuracy_score
print(classification_report(np.argmax(trainY_CNN, axis=1), np.argmax(cnn_model.predict(trainX_CNN), axis=1)))

# %% colab={"base_uri": "https://localhost:8080/"} id="keQ-SDoldpVk" outputId="2525726d-dfe8-455f-9477-77ee0159674d"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="OVLQKnEkeutR" outputId="37f8122b-9d49-43a5-c5c9-bdf3e1ca27d7"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="hSkQfuWLgXLr" outputId="8d09bba6-0f29-4ea9-b910-25c491008f1e"
import numpy as np
import tensorflow as tf
...
# %% colab={"base_uri": "https://localhost:8080/"} id="HAzxmbD0iJ95" outputId="3f715c8c-2b2b-485c-d070-006e2acfc312"
import numpy as np
import tensorflow as tf
from sklearn.metrics import accuracy_score
from tensorflow.keras.utils import to_categorical
...
# %% colab={"base_uri": "https://localhost:8080/"} id="d5a11858" outputId="a9d9c66d-df74-46af-e3bd-32adccab1483"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="a3d9f168" outputId="0a700736-7ba1-4484-805a-7ca3ae7f24cc"
"""TRADING STRATEGY AFTER ATTACK ON 4 EPSILON VALUES"""
import numpy as np
import pandas as pd
import tensorflow as tf
